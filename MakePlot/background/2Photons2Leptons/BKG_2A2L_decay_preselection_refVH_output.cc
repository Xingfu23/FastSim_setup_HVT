...
void Zp_delphes_output(const char *inputFile){
	...
	for (Int_t entry = 0; entry < numberOfEntries; ++entry){
		...
		// There are at least two leptons and two photon of each event.
		// The Pt of both lepton should greater than 30 GeV.
		// The mass of dilepton is between 80GeV and 110GeV.
		...
		if (branchMuon->GetEntries() == 0 && branchElectron->GetEntries() > 1){
			...
			for (int entry1 = 0; entry1 < branchElectron->GetEntries(); entry1++){
				...
				for (int entry2 = entry1 + 1; entry2 < branchElectron->GetEntries(); entry2++){
					...
					if ((L1+L2).M() < 80. || (L1+L2).M() > 110.) continue;
		...
		// For photon part, we ask that the Pt of leading photon must greater than 1/3*diphoton mass 
		// and the Pt of sublading photon should bigger than 1/4*diphoton mass.
		...
		for (int entry1 = 0; entry1 < branchPhoton->GetEntries(); entry1++){
			...
			if (branchPhoton->GetEntries() > 1){
				for (int entry2 = entry1 + 1; entry2 < branchPhoton->GetEntries(); entry2++){
					...
					if (a1.Pt() < (a1+a2).M()/3. || a2.Pt() < (a1+a2).M()/4.) continue;
	...
	cout << "Event with 2 Leptons and 2 Photons: " << Event_No_with2A2L << endl;
...
// Main output process
void BKG_2A2L_decay_preselection_refVH_output(){
	Zp_delphes_output("Delphes_BKG_ZGTo2LG_01Jet_LO_MLM_0_20.root");
	Zp_delphes_output("Delphes_BKG_ZGTo2LG_01Jet_LO_MLM_20_50.root");
	Zp_delphes_output("Delphes_BKG_ZGTo2LG_01Jet_LO_MLM_50_100.root");
	Zp_delphes_output("Delphes_BKG_ZGTo2LG_01Jet_LO_MLM_100_200.root");
	Zp_delphes_output("Delphes_BKG_ZGTo2LG_01Jet_LO_MLM_200_300.root");
	Zp_delphes_output("Delphes_BKG_ZGTo2LG_01Jet_LO_MLM_300_500.root");
	Zp_delphes_output("Delphes_BKG_ZGTo2LG_01Jet_LO_MLM_500_700.root");
	Zp_delphes_output("Delphes_BKG_ZGTo2LG_01Jet_LO_MLM_700_1000.root");
	Zp_delphes_output("Delphes_BKG_ZGTo2LG_01Jet_LO_MLM_1000_1500.root");
	Zp_delphes_output("Delphes_BKG_ZGTo2LG_01Jet_LO_MLM_1500_2000.root");
	Zp_delphes_output("Delphes_BKG_ZGTo2LG_01Jet_LO_MLM_2000_Inf.root");
	Zp_delphes_output("Delphes_BKG_Z2GTo2L2G_01Jet_LO_MLM_0_20.root");
	Zp_delphes_output("Delphes_BKG_Z2GTo2L2G_01Jet_LO_MLM_20_50.root");
	Zp_delphes_output("Delphes_BKG_Z2GTo2L2G_01Jet_LO_MLM_50_100.root");
	Zp_delphes_output("Delphes_BKG_Z2GTo2L2G_01Jet_LO_MLM_100_200.root");
	Zp_delphes_output("Delphes_BKG_Z2GTo2L2G_01Jet_LO_MLM_200_300.root");
	Zp_delphes_output("Delphes_BKG_Z2GTo2L2G_01Jet_LO_MLM_300_500.root");
	Zp_delphes_output("Delphes_BKG_Z2GTo2L2G_01Jet_LO_MLM_500_700.root");
	Zp_delphes_output("Delphes_BKG_Z2GTo2L2G_01Jet_LO_MLM_700_1000.root");
	Zp_delphes_output("Delphes_BKG_Z2GTo2L2G_01Jet_LO_MLM_1000_1500.root");
	Zp_delphes_output("Delphes_BKG_Z2GTo2L2G_01Jet_LO_MLM_1500_2000.root");
	Zp_delphes_output("Delphes_BKG_Z2GTo2L2G_01Jet_LO_MLM_2000_Inf.root");
}
